...
from src.utils.monitoring import get_monitor, PerformanceMonitor
...
# Ajusta o caminho de importação para o diretório raiz do projeto
import os
import sys
...
if not src_dir.exists():
    raise FileNotFoundError(f"Diretório src não encontrado em {project_root}")

# Garante que o diretório src também está no PYTHONPATH
...
def setup_environment(args):
    ...
    output_dir = os.path.join(backtest_dir, f"run_{timestamp}")
